...
# setup.sh - Simple React Native/Expo template setup script
...
print_header() {
    echo
    echo "🚀 React Native/Expo Template Setup"
    echo "==================================="
    echo
}
...
print_summary() {
    ...
    echo "================"
    echo
    echo "React Native/Expo template setup completed! Next steps:"
